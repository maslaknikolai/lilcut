    ...
    <div className="relative z-10 w-0 shrink-0">
      <button
        ...
        className={cn(
          ...
          'absolute inset-y-1 -left-3 flex w-6 cursor-pointer items-center justify-center rounded bg-slate-600 text-slate-300 after:absolute after:inset-y-0 after:-inset-x-2 hover:bg-slate-700 hover:text-slate-100 active:bg-slate-500',
          className,
        )}
